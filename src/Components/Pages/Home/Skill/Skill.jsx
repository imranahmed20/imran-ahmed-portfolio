...
const Skill = () => {
    return (
        <div style={{ marginTop: "130px", marginBottom: "110px" }}>
            <h1 className='text-3xl font-bold text-center' style={{ marginBottom: '50px', color: "#fec544" }}>SKILLS</h1>
            <div className="grid md:grid-cols-2 gap-8 mt-16">
                ...
                <div>
                    ...
                    <hr className="mb-5 border-orange-300 border" />
                    <div className="flex justify-between">
                    ...
                    <hr className="mb-2 border-orange-300 border" />
                </div>
            </div>
        </div>
    );
